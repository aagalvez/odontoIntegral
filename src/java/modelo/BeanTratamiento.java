...
public class BeanTratamiento
{
	...
	public void read(String id)
	{
		...
		try
		{
			...
			if(con != null)
			{
				PreparedStatement ps = con.prepareStatement("select * from tratamiento where idtratamiento = ?");
				ps.setString(1,id);
	...
	public void add(String id, String descripcion, String duracion, String presupuesto)
	{
			...
			try
			{
				...
				if(con!=null)
				{
					PreparedStatement ps = con.prepareStatement("insert tratamiento values(?,,?,?,?)");
					ps.setString(1,id);
	...
	public void update(String id, String descripcion, String duracion, String presupuesto)
	{
			try
			{
				...
				if(con!=null)
				{
					...
					{
						PreparedStatement ps1 = con.prepareStatement("UPDATE tratamiento SET idTratamiento = ?,descripcion = ?, duracion = ?, presupuesto = ? where idTratamiento = ?");
						ps1.setString(4,id);
	...
	public String[][] readAll()
	{
		...
		try
		{
			...
			if(con != null)
			{
				...
				st.executeQuery("select * from tratamiento order by idTratamiento");
